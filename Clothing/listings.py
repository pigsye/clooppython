...
listings_bp = Blueprint("listings", __name__, url_prefix="/api/products")
...
@listings_bp.route('/listing/<int:product_id>', methods=['GET'])
...
@listings_bp.route('/update/<int:product_id>', methods=['POST'])
...
@listings_bp.route('/delete/<int:product_id>', methods=['DELETE'])
