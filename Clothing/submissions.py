...
@clothing_bp.route('/submissions', methods=['GET'])
def get_submissions():
    """
...
@clothing_bp.route('/add', methods=['POST'])
def add_product():
    """
...
@clothing_bp.route('/deletesubmission', methods=['POST'])
...
@clothing_bp.route('/addsubmission', methods=['POST'])
def add_submission():
    """
...
@clothing_bp.route('/editsubmission', methods=['POST'])
def edit_submission():
    """
