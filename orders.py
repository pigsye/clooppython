...
@orders_bp.route('/<int:order_id>/update_user', methods=['POST'])
...
@orders_bp.route('/<int:order_id>/update_address', methods=['POST'])
...
@orders_bp.route('/<int:order_id>/remove_product', methods=['POST'])
...
@orders_bp.route('/<int:order_id>/delete', methods=['DELETE'])
